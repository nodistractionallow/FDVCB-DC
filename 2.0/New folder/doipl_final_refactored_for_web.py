...
def run_league_match(team1, team2, is_rain_match, current_points, current_batting_info, current_bowling_info, web_mode=True):
    ...
    try:
        ...
        # Assuming mainconnect.game does not write files if web_mode is True, or if its file writing is acceptable.
...
if __name__ == "__main__":
    ...
    if not is_web_mode:
        ...
        # For web mode, the data is available in the variables.
        # The web application would take these variables and format them for display.
        # This print statement is a placeholder for web integration.
        print("Tournament simulation complete (web_mode=True). Winner: " + str(tournament_champion))
        # To make data accessible for a web API, you might structure it like this:
        # full_tournament_output = {
        #     "teams": TEAMS,
        #     "final_points_table": get_points_table(points, TEAMS),
        #     "final_batting_info": battingInfo,
        #     "final_bowling_info": bowlingInfo,
        #     "top_players": get_top_players(battingInfo, bowlingInfo),
        #     "league_phase_match_results": league_match_results,
        #     "playoff_phase_match_results": playoff_match_results,
        #     "tournament_winner": tournament_champion
        # }
        # (Further processing or JSON serialization would happen in the web app layer)
else:
    # This block allows individual function testing if the script is imported elsewhere.
    pass
